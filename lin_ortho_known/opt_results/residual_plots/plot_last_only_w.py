...
filenames = ['residuals_blue00_w.npy',
             'residuals_blue01_w.npy',
             'residuals_blue02_w.npy',
             'residuals_blue03_w.npy']
...
# for residual_file in filenames:
    ...
    # save each fig
    fig_dx.savefig('last_dx' + str(i) + '_w.png', bbox_inches='tight', dpi=300)
    fig_dy.savefig('last_dy' + str(i) + '_w.png', bbox_inches='tight', dpi=300)
    fig_dz.savefig('last_dz' + str(i) + '_w.png', bbox_inches='tight', dpi=300)
